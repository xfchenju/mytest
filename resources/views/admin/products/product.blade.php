	...
	<script>
		...
		layui.use(['table', 'jquery'], function(){
		  ...
		  $(window).resize(function(){
		  	var width = $('.layui-table').parent().width()
		  	$('.layui-table').width(width)
		  })
		 /* window.onresize = function() {
		  	var bodyWidth = document.getElementsByClassName('layui-body')[0].clientWidth
		  	
		  	document.getElementsByClassName('layui-table')[0].style.width = bodyWidth
		  	console.log(bodyWidth, document.getElementsByClassName('layui-table')[0].clientWidth)
		  }*/
		});
